...
const std::vector<std::vector<float>> variances = {{0.1f, 0.1f, 0.2f, 0.2f}};

const std::vector<bool> clips = {true, false};

const std::vector<std::vector<size_t>> input_shape = {{1, 16, 4, 4}};
const std::vector<std::vector<size_t>> image_shape = {{1, 3, 50, 50}};

const auto layerSpeficParams =
    ::testing::Combine(::testing::ValuesIn(widths), ::testing::ValuesIn(heights), ::testing::ValuesIn(clips),
                       ::testing::ValuesIn(step_widths), ::testing::ValuesIn(step_heights),
...
INSTANTIATE_TEST_CASE_P(PriorBoxClustered_Basic, PriorBoxClusteredLayerTest,
                        ::testing::Combine(layerSpeficParams, ::testing::ValuesIn(netPrecisions),
                                           ::testing::ValuesIn(input_shape), ::testing::ValuesIn(image_shape),
